...
import com.example.ekansgame.Pool;
import com.example.ekansgame.Pool.PoolObjectFactory;

public class MultTouchHandler implements TouchHandler{
    ...
    public MultTouchHandler(View view, float scaleX, float scaleY) {
